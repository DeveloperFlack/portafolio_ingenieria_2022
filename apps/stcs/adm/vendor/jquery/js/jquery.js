/*! jQuery v3.6.1 | (c) OpenJS Foundation and other contributors | jquery.org/license */ ! function (e, t) {
    ...
    /**
     * Esta función crea un elemento de secuencia de comandos, establece el texto del elemento de
     * secuencia de comandos en el primer argumento y luego agrega el elemento de secuencia de comandos
     * al encabezado del documento.
     * @param e - El código JavaScript a ejecutar.
     * @param t - la etiqueta del guión
     * @param n - el objeto del documento
     */
    function b(e, t, n) {
    ...
    /**
     * Si el valor de e es nulo, devuelve el valor de e como una cadena; de lo contrario, si el valor
     * de e es un objeto o una función, devuelve el valor de e como un objeto; de lo contrario,
     * devuelve el valor de e como una cadena .
     * @param e - El valor a probar.
     * @returns El tipo de la variable.
     */
    function w(e) {
